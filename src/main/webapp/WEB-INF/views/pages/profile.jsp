...
<body>
	...
	<main>
		<section class="container" style="width: 600px">
			<header>회원 정보</header>
			<form name=form1 action="../user/user_modify/" method="post">
				<table>
					<tr>
					...
					<tr>
						<th>PASSWORD</th>
						<td><input type="text" name="userPasswd"
							value="${user.userPasswd}"></td>
					</tr>
					<tr>
						<th>NAME</th>
					...
					<tr>
						<td><button type="button"
								onclick="location.href='../user/user_delete?userId=${user.userId}'"
								id="button">계정 탈퇴</button></td>
						<td><button type="button"
								onclick="location.href='../user/logout'" id="button">로그아웃</button></td>
